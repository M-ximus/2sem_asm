...
static void set_indicator(uint8_t number)
{
     ...
     * indictor (that is done by using masking)
     */
...
static void print_arr_of_num(int dig_1, int dig_2, int dig_3, int dig_4, char dp_mask)
{		
	static const uint32_t arr_of_numbers[16] = {	LL_GPIO_PIN_0 | LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4 | LL_GPIO_PIN_5,\
							LL_GPIO_PIN_1 | LL_GPIO_PIN_2,\
							LL_GPIO_PIN_0 | LL_GPIO_PIN_1 | LL_GPIO_PIN_6 | LL_GPIO_PIN_4 | LL_GPIO_PIN_3,\
							LL_GPIO_PIN_0 | LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_6,\
							LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6,\
							LL_GPIO_PIN_0 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6,\
							LL_GPIO_PIN_0 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6,\
							...
							LL_GPIO_PIN_0 | LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6,\
							LL_GPIO_PIN_0 | LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_4 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6,\
							LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6,\
							LL_GPIO_PIN_0 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4 |	LL_GPIO_PIN_5,\
							LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4 | LL_GPIO_PIN_6,\
							LL_GPIO_PIN_0 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6,\
							LL_GPIO_PIN_0 | LL_GPIO_PIN_4 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6};


	uint32_t mask = LL_GPIO_PIN_0 | LL_GPIO_PIN_1 | LL_GPIO_PIN_2 | LL_GPIO_PIN_3 | LL_GPIO_PIN_4 | LL_GPIO_PIN_5 | LL_GPIO_PIN_6 | LL_GPIO_PIN_7;
	uint8_t status = 0;
	uint32_t print  = LL_GPIO_ReadOutputPort(GPIOB);
	print = print & ~mask;
	...
	if (dig_1 != -1)
	{
		dig_1 %= 16;
		status = dp_mask & 1;
		print  = (arr_of_numbers[dig_1]) | (LL_GPIO_PIN_7 * status);
		LL_GPIO_SetOutputPin(GPIOB, print);
	...
	status = 0;
        ...
        if (dig_2 != -1)
        {
                dig_2 %= 16;
                status = dp_mask & 2;
                print  = (arr_of_numbers[dig_2]) | (LL_GPIO_PIN_7 * status);
                LL_GPIO_SetOutputPin(GPIOB, print);
	...
	status = 0;
        ...
        if (dig_3 != -1)
        {
                dig_3 %= 16;
                status = dp_mask & 4;
                print  = (arr_of_numbers[dig_3]) | (LL_GPIO_PIN_7 * status);
                LL_GPIO_SetOutputPin(GPIOB, print);
	...
	status = 0;
        ...
        if (dig_4 != -1)
        {
                dig_4 %= 16;
                status = dp_mask & 8;
                print  = (arr_of_numbers[dig_4]) | (LL_GPIO_PIN_7 * status);
                LL_GPIO_SetOutputPin(GPIOB, print);
...
int main(void)
{
  ...
  // set_indicator(number);
   ...
   print_arr_of_num(number, number, number, number, 0);

	while(1)
	{
		print_arr_of_num(1,2,3,4,1);
	}
    ...
    while (1) {
        ...
        if (debouncer_clk >= 5) {
            ...
            number++;
            //set_indicator(number);
            print_arr_of_num(number, 0, 0, 0, 0);
	    button_pressed = 0;
            debouncer_clk = 0;
        }
#else
